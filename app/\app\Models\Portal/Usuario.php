 ...
 * @property TbToken[] $tbTokens
 * @property TbRepresentacao[] $tbRepresentacaos
 */
class Usuario extends Model
{
     ...
     */
    public function tbTokens()
    {
        return $this->hasMany('\App\Models\Portal\TbToken', 'id_usuario', 'id_usuario');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function tbRepresentacaos()
    {
        return $this->hasMany('\App\Models\Portal\TbRepresentacao', 'id_usuario', 'id_usuario');
    }
}
